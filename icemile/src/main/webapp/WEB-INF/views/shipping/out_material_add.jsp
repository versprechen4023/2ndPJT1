...
<tr>
<!-- 출고 코드 -->
<td><input type="text" name="out_code" size="12"></td>
<!-- 출고 창고 코드 -->
<td><input type="text" name="out_wh_code" size="12"></td>
<!-- 수주 코드 -->
<td><input type="text" name="order_code"  size="12"></td>
<!-- 출고 담당자 -->
<td><input type="text" name="emp_num"  size="12"></td>
<!-- 출고 현황 -->
<td><input type="text" name="out_status" size="12"></td>
...
<!-- 비고 -->
<td><input type="text" name="out_material_note"  size="6"></td>
</tr>
