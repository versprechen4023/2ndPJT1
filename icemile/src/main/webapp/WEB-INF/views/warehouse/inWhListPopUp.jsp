...
<form id="warehouseList">
                <main>
                <!-- 내용들어가는곳 -->
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">창고 관리</h1>
                        ...
                        <div class="card mb-4">
							...
							<select id="category">
  								<option value="wh_code">창고 코드</option>
  								<option value="wh_name">창고 이름</option>
  								<option value="wh_type">창고 종류</option>
							</select>
							...
							<input type="button" name="search" value="조회" onclick="warehouseSearch()">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach var="WarehouseInsertDTO" items="${warehouseList}">
                                        <tr>
                                            <td>${WarehouseInsertDTO.wh_code}</td>
...
$(document).ready(function() {
	...
	$(document).on("click", "tbody tr", function() {
	      ...
	      var wh_code = $(this).find("td:eq(0)").text();
	      var wh_name = $(this).find("td:eq(1)").text();
	      var wh_phone = $(this).find("td:eq(2)").text();
	      var prod_code = $(this).find("td:eq(3)").text();
	      var raw_code = $(this).find("td:eq(4)").text();
	      var emp_num = $(this).find("td:eq(5)").text();
		  

	      // 부모창으로 값을 전달한다
	      // getElementById부모 창에서 해당 입력 필드를 찾고 값을 설정하기 위해 사용된다.
	      opener.document.getElementById("in_wh_code").value = wh_code;
