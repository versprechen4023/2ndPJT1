...
function prodStockSearchPopUp() {
	   ...
	   // 검색 결과값을 받아오기 위한 ajax 호출
 	   $.ajax({
 			  url : '${pageContext.request.contextPath}/warehouse_ajax/prodStockSearchPopUp',
                ...
                <!-- 내용들어가는곳 -->
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<select id="category">
  								<option value="prod_code">완제품 코드</option>
  								<option value="prod_name">완제품 품명</option>
  								<option value="prod_taste">완제품 종류</option>
							</select>
							<input type="text" name="content" size=20 placeholder="검색어를 입력하세요"
								id="content">
							<input type="button" name="search" value="조회" onclick="prodStockSearchPopUp()">
</form>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach var="StockDTO" items="${productList}">
                                        <tr>
